...
<CardGroup cols={1}>
<Card title="Démarrage rapide" icon="rocket" href="/quickstart" color="#C9CBD1"> Envoyez votre premier SMS et commencez à recevoir les événements de livraison. </Card>
</CardGroup>
<CardGroup cols={2}>
<Card title="Types d'événements" icon="list" href="/webhooks/types" color="#C9CBD1"> Consultez tous les types d'événements webhook et la forme de leurs payloads. </Card>
<Card title="Développement local" icon="terminal" href="/webhooks/local-development" color="#C9CBD1"> Testez les webhooks en local avec des tunnels et la CLI Rewrite. </Card>
</CardGroup>
