  ...
  <thead>
    ...
    <tbody>
      <tr>
        ...
        <td style={{ padding: '11px 14px', borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>Immédiatement</td>
      </tr>
      <tr>
        <td style={{ padding: '11px 14px', borderBottom: '1px solid rgba(255, 255, 255, 0.08)', borderRight: '1px solid rgba(255, 255, 255, 0.12)' }}>2</td>
        <td style={{ padding: '11px 14px', borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>5 secondes</td>
      </tr>
      <tr>
...
<Card title="Vérifier les signatures webhook" icon="shield-check" href="/webhooks/signatures" color="#C9CBD1"> Validez toujours l'en-tête de signature avant de faire confiance à un payload webhook. </Card>
