...
<Tabs sync={false}>
  <Tab title="PAYG">
    ...
    **Preco:** `0.18` por SMS (conforme politica comercial da Rewrite).
...
Use `X-RateLimit-Retry-After` como hint de retry.

## Padroes de arquitetura para trabalhar com quota

<CardGroup cols={2}>
  <Card title="Fila de envio" icon="list-tree" color="#C9CBD1">
    Faça buffer de trafego de saida e drene com concorrencia controlada.
  </Card>
