  ...
  <thead>
    ...
    <tbody>
      <tr>
        ...
        <td style={{ padding: '11px 14px', borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>Imediatamente</td>
      </tr>
      <tr>
...
<Card title="Validar assinaturas de webhook" icon="shield-check" href="/pt-br/webhooks/signatures" color="#C9CBD1"> Sempre valide o header de assinatura antes de confiar no payload. </Card>
