...
<Card title="Desenvolvimento local" icon="terminal" href="/pt-br/webhooks/introduction" color="#C9CBD1"> Teste webhooks localmente com tuneis e a Rewrite CLI. </Card>
</CardGroup>
