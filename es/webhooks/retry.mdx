...
<Card title="Verifica las firmas de webhook" icon="shield-check" href="/webhooks/signatures" color="#C9CBD1"> Valida siempre la cabecera de firma antes de confiar en las cargas de webhook. </Card>
